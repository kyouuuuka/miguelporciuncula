...
function ProjectCard({ project: p, className = "" }) {
  ...
  return (
    <Card
      data-card
      {...linkProps}
      className={`group flex flex-col overflow-hidden rounded-2xl border border-paper/10 bg-ink/40 transition-colors duration-400 hover:border-paper/30 ${className}`}
    >
